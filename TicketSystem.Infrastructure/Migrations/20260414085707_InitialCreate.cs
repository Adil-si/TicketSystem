...
namespace TicketSystem.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TicketId = table.Column<int>(type: "int", nullable: false),
                    BlockedByTicketId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlockedBy", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BlockedBy_Tickets_BlockedByTicketId",
                        column: x => x.BlockedByTicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BlockedBy_Tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlockedBy_BlockedByTicketId",
                table: "BlockedBy",
                column: "BlockedByTicketId");

            migrationBuilder.CreateIndex(
                name: "IX_BlockedBy_TicketId_BlockedByTicketId",
                table: "BlockedBy",
                columns: new[] { "TicketId", "BlockedByTicketId" },
                unique: true);
